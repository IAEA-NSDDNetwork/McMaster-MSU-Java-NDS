...
public class MoreDelaySettingFrame extends BaseMoreSettingFrame {
    ...
    public MoreDelaySettingFrame(MassChain mass,EnsdfWrap curEnsdf,javands.main.Run r) {
	...
	protected void displayTableControl(){
		...
		setEnabledAndSelected(checkBox_E1, tc,"E");setSelected(checkBox_E1,columns,"E"); 
		setEnabledAndSelected(checkBox_IP1, tc,"RI");setSelected(checkBox_IP1,columns,"RI"); 
		setEnabledAndSelected(checkBox_LEV1, tc,"LEV");setSelected(checkBox_LEV1,columns,"LEV"); 
		setEnabledAndSelected(checkBox_EI1,tc,"EI");setSelected(checkBox_EI1,columns,"EI");
		
		columns=tc.getFcolumns();
		//debug
		//System.out.println("In MoreDelaySettings: Fcolumns="+columns+" E isSelected"+checkBox_E2.isSelected());
		
		setEnabledAndSelected(checkBox_E2, tc,"E");setSelected(checkBox_E2,columns,"E"); 
		setEnabledAndSelected(checkBox_IP2, tc,"RI");setSelected(checkBox_IP2,columns,"RI"); 
		setEnabledAndSelected(checkBox_LEV2, tc,"LEV");setSelected(checkBox_LEV2,columns,"LEV"); 
		setEnabledAndSelected(checkBox_EI2,tc,"EI");setSelected(checkBox_EI2,columns,"EI");
	...
	protected void updateTableControl(){
		...
		if(checkBox_E1.isSelected()) addColumn(columns,"E");
		if(checkBox_IP1.isSelected()) addColumn(columns,"RI");
		if(checkBox_LEV1.isSelected()) addColumn(columns,"LEV");
		if(checkBox_EI1.isSelected()) addColumn(columns,"EI");
		if(columns.size()>0) 
			tc.setDataAsComments(columns);
				
		columns=new Vector<String>();
		if(checkBox_E2.isSelected()) addColumn(columns,"E");
		if(checkBox_IP2.isSelected()) addColumn(columns,"RI");
		if(checkBox_LEV2.isSelected()) addColumn(columns,"LEV");
		if(checkBox_EI2.isSelected()) addColumn(columns,"EI");
		if(columns.size()>0) 
    ...
    protected void initComponents() {
        ...
        this.setTitle("More settings for delay table control.");
        ...
        checkBox_E1 = new JCheckBox("E");
        checkBox_E1.setToolTipText("particle energy");
        
        checkBox_IP1 = new JCheckBox("IP");
        
        checkBox_LEV1 = new JCheckBox("ED");
        checkBox_LEV1.setToolTipText("daughter level energy");
        
        checkBox_EI1 = new JCheckBox("EI");
        checkBox_EI1.setToolTipText("intermediate level energy");
        ...
        gl_panel_2.setHorizontalGroup(
        	gl_panel_2.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel_2.createSequentialGroup()
        			...
        			.addComponent(checkBox_E1, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(checkBox_IP1)
        			.addGap(5)
        			.addComponent(checkBox_LEV1)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(checkBox_EI1)
        	...
        	gl_panel_2.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel_2.createSequentialGroup()
        			...
        			.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
        				.addComponent(checkBox_E1, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
        				.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
        					.addComponent(checkBox_IP1, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
        					.addComponent(label_2))
        				.addComponent(checkBox_LEV1, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
        				.addComponent(checkBox_EI1))
        			.addGap(1))
        );
        ...
        checkBox_E2 = new JCheckBox("E");
        checkBox_E2.setToolTipText("particle energy");
        
        checkBox_IP2 = new JCheckBox("IP");
        
        checkBox_LEV2 = new JCheckBox("ED");
        checkBox_LEV2.setToolTipText("daughter level energy");
        
        checkBox_EI2 = new JCheckBox("EI");
        checkBox_EI2.setToolTipText("intermediate level energy");
        ...
        gl_panel.setHorizontalGroup(
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(checkBox_E2, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(checkBox_IP2)
        			.addGap(5)
        			.addComponent(checkBox_LEV2)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(checkBox_EI2)
        			.addContainerGap(133, Short.MAX_VALUE))
        );
        	...
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			...
        			.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
        				.addComponent(checkBox_E2, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
        				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
        					.addComponent(checkBox_IP2, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
        					.addComponent(lblOnlyPrintRow))
        				.addComponent(checkBox_LEV2, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
        				.addComponent(checkBox_EI2))
        			.addGap(1))
        );
        ...
        groupLayout.setHorizontalGroup(
        	groupLayout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(groupLayout.createSequentialGroup()
        			.addContainerGap()
        			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        				.addComponent(chckbxPutFootnotesIn, GroupLayout.PREFERRED_SIZE, 312, GroupLayout.PREFERRED_SIZE)
        				.addComponent(panel_4, GroupLayout.PREFERRED_SIZE, 580, GroupLayout.PREFERRED_SIZE)))
        		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
        			.addGroup(groupLayout.createSequentialGroup()
        				.addGap(13)
        				.addComponent(lblBreakPointslevel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        			.addGroup(groupLayout.createSequentialGroup()
        				.addGap(10)
        				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(groupLayout.createSequentialGroup()
        			.addGap(13)
        			.addComponent(label_4, GroupLayout.PREFERRED_SIZE, 550, GroupLayout.PREFERRED_SIZE))
        );
    ...
    private JCheckBox checkBox_E1;
    private JCheckBox checkBox_IP1;
    private JCheckBox checkBox_LEV1;
    private JCheckBox checkBox_EI1;
    private JCheckBox chckbxPutFootnotesIn;
    private JPanel panel;
    private JLabel lblOnlyPrintRow;
    private JCheckBox checkBox_E2;
    private JCheckBox checkBox_IP2;
    private JCheckBox checkBox_LEV2;
    private JCheckBox checkBox_EI2;
